...
export default function Home() {
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#F4F1EA] text-[#18221F] landing-scope">
      ...
      <section
        id="platform"
        className="scroll-mt-32 lg:scroll-mt-36 mx-auto grid max-w-[1400px] items-center gap-6 px-4 sm:px-6 pb-4 pt-32 sm:pt-24 lg:grid-cols-[1.05fr_0.95fr] lg:gap-8 lg:px-10 lg:pb-6 lg:pt-28"
      >
